...
### Security
- Resolve npm audit vulnerabilities in qs — array-limit bypass via bracket-key comma parsing (GHSA-x5fp-wj9c-mxmx) and denial of service via attacker-controlled isBuffer (GHSA-4mjr-xmp4-gh2g) (#126)
- Resolve npm audit vulnerability in @humanfs/node transitive dependency — recursive copy follows symlinked files (GHSA-p498-v437-472g) (#127)
...
### Added
- Add Playwright e2e tests covering the popup and redirect authorization flows (#106)

### Security
- Resolve npm audit vulnerabilities in transitive dependencies (#107)
